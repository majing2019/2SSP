...
class CompressedQwen2DecoderLayer(Qwen2DecoderLayer):
    ...
    (https://github.com/huggingface/transformers/blob/main/src/transformers/models/qwen2/modeling_qwen2.py#L376)
...
class Qwen2ModelAdapter(ModelAdapter):
    ...
    def _from_pretrained(
        ...
        *,
        ...
        if not (model_name.startswith("Qwen/Qwen2.5-7B") or model_name.startswith("Qwen/Qwen2.5-7B")):
            return None
